# RailsAdmin config file. Generated on June 13, 2013 14:06
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Hackernews', 'Admin']
  ...
  # config.excluded_models = ['Post', 'User', 'Vote']

  # Include specific models (exclude the others):
  # config.included_models = ['Post', 'User', 'Vote']
